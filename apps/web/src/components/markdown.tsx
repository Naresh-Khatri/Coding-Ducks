...
/**
 * Shared GitHub-flavored markdown renderer + component styles. Used by the
 * problem statement, practice descriptions, and editorials so they all render
 * identically.
 */
...
/** Render a GitHub-flavored markdown string with the shared component styles. */
