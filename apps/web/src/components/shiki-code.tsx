  ...
  return (
    <div className="group relative">
      <Button
        variant="ghost"
        size="icon"
        className="absolute top-0 right-0 size-6 opacity-0 transition-opacity group-hover:opacity-100"
        onClick={handleCopy}
      >
        {copied ? (
      ...
      {html ? (
        // html is generated by the trusted shiki highlighter from code props — not user-controlled HTML
        <div
